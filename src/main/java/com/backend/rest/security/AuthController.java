...
@CommonsLog
@RestController
@RequestMapping("/apiClinica/auth")
...
public class AuthController {
    ...
    public ResponseEntity<JwtDto> login(@RequestBody LoginUsuario loginUsuario){
        ...
        JwtDto jwtDto = new JwtDto(jwt,  usuario.getUsername(),usuario.getNombreCompleto(), usuario.getIdUsuario(), usuario.getAuthorities(), usuario.getMenus());
